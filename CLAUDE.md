...
Scripts in scope (project root `.py` files):
backtest.py, confidence_calibration.py, diagnostics.py, dynamic_weighting.py,
ensemble_utils.py, model.py, model_self_check.py, moomoo_paper_trading.py,
